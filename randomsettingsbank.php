...
<script src="/ipm/js/bgprocess.js"></script>
	...
	<script>
		...
		function editrandom(active)
		{
			...
			var subject = active.parentNode.parentNode.getElementsByTagName('td')[3].innerHTML;
			...
			document.forms["randomSelect"]["active"].value=activ;
			...
			document.forms["randomSelect"]["subject"].value=subject;
	...
	<div id="surface">
		<div id="body_card">
			<?php
				...
				$query="SELECT * from `ipm`.`random_sub`;";
			...
			<form name="randomSelect" method="post" action="backend/changestatusrandomsubject.php">
