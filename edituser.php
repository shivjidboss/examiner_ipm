		...
		<div id="body_card">
			<div id="signupform">
				<font color="#333333" face="Tahoma, Geneva, sans-serif"><h3>Edit Student</h3>
					<form name="signup" action="editusersignup.php" method="post">
						<table id="signup_tble">
							...
							<?php
								if(isset($_COOKIE['authenpass'])&& $_COOKIE['authenpass']== "wrong")
									{
										echo("<tr><td colspan='2''><font color='#C00609'>Enter admin password!</font></td><tr>");
										unset($_COOKIE['authenpass']);
									}
							?>	
							<tr>
								<td colspan="2"><center><input type="submit" name="submit" value="Edit" class="submit" /></center></td>
							</tr>
						</table>
					</form>  
				</font> 
